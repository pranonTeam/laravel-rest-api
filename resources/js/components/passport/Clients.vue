    ...
    export default {
        ...
        methods: {
            ...
            prepareComponent() {
                ...
                jQuery('#modal-create-client').on('shown.bs.modal', () => {
                    jQuery('#create-client-name').focus();
                });

                jQuery('#modal-edit-client').on('shown.bs.modal', () => {
                    jQuery('#edit-client-name').focus();
                });
            },
            ...
            showCreateClientForm() {
                jQuery('#modal-create-client').modal('show');
            },
            ...
            edit(client) {
                ...
                jQuery('#modal-edit-client').modal('show');
            },
            ...
            showClientSecret(clientSecret) {
                ...
                jQuery('#modal-client-secret').modal('show');
            },
